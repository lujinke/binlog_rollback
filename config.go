...
func (this *ConfCmd) ParseCmdOptions() {
	...
	flag.UintVar(&this.ThreadID, "tid", 0, "only parse binlog events generated by this mysql thread_id. For row format DML, the thread_id is read from the preceding QUERY_EVENT in the same transaction. default parse all thread ids")
	...
	this.IfSetThreadID = this.ThreadID > 0
